...
public static class NuGetFrameworkHelper
{
    ...
    static NuGetFrameworkHelper()
    {
        ...
        _nugetFrameworks["net6.0-android"] = new[] { new NuGetFramework(".NETCoreApp", new Version(6, 0, 0, 0), "android", FrameworkConstants.EmptyVersion) };
        _nugetFrameworks["net6.0-ios"] = new[] { new NuGetFramework(".NETCoreApp", new Version(6, 0, 0, 0), "ios", FrameworkConstants.EmptyVersion) };
        _nugetFrameworks["net7.0"] = new[] { FrameworkConstants.CommonFrameworks.Net70 };
        _nugetFrameworks["net7.0-android"] = new[] { new NuGetFramework(".NETCoreApp", new Version(7, 0, 0, 0), "android", FrameworkConstants.EmptyVersion) };
        _nugetFrameworks["net7.0-ios"] = new[] { new NuGetFramework(".NETCoreApp", new Version(7, 0, 0, 0), "ios", FrameworkConstants.EmptyVersion) };
        _nugetFrameworks["net8.0"] = new[] { new NuGetFramework(".NETCoreApp", new Version(8, 0, 0, 0)) };
        _nugetFrameworks["net8.0-android"] = new[] { new NuGetFramework(".NETCoreApp", new Version(8, 0, 0, 0), "android", FrameworkConstants.EmptyVersion) };
        _nugetFrameworks["net8.0-ios"] = new[] { new NuGetFramework(".NETCoreApp", new Version(8, 0, 0, 0), "ios", FrameworkConstants.EmptyVersion) };
